...
namespace CryptoTools.Core.Api.Bittrex
{
    ...
    public class BittrexClient
    {
        ...
        public async Task<ApiResult<OrderResult>> BuyLimit(string marketName, double quantity, double rate)
        {
            ...
            var url = $"{_marketBaseUrl}/buylimit?apiKey={_apiKey}&nonce={nonce}&market={marketName}&quantity={quantity:0.000000000000}&rate={rate:0.000000000000}";
            url = url.Replace(",", ".");
        ...
        public async Task<ApiResult<OrderResult>> SellLimit(string marketName, double quantity, double rate)
        {
            ...
            var url = $"{_marketBaseUrl}/selllimit?apiKey={_apiKey}&nonce={nonce}&market={marketName}&quantity={quantity:0.000000000000}&rate={rate:0.000000000000}";
            url = url.Replace(",", ".");
